...
/bin/sed -i "/\$mailfrom /c\        public \$mailfrom = \'${SYSTEM_FROMEMAIL_ADDRESS}\';" ${BUILD_HOME}/buildconfiguration/configuration.php.default
/bin/sed -i "/\$replyto /c\        public \$replyto = \'${SYSTEM_TOEMAIL_ADDRESS}\';" ${BUILD_HOME}/buildconfiguration/configuration.php.default
...
/bin/sed -i "/\$smtpuser /c\        public \$smtpuser = \'${SYSTEM_EMAIL_USERNAME}\';" ${BUILD_HOME}/buildconfiguration/configuration.php.default
/bin/sed -i "/\$smtppass /c\        public \$smtppass = \'${SYSTEM_EMAIL_PASSWORD}\';" ${BUILD_HOME}/buildconfiguration/configuration.php.default
